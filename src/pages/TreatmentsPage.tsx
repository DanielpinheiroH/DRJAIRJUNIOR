...
export default function TreatmentsPage() {
  ...
  return (
    <>
      <SEO title={`Tratamentos odontológicos${locationSuffix} | Dr. Jair Júnior`} description="Conheça possibilidades em implantes, reabilitação oral, estética, prevenção, endodontia, periodontia, cirurgia e bruxismo." canonical="/tratamentos" breadcrumbs={breadcrumbs} />
